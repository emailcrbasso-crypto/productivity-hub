...
import type { ImpactEffortTask, QuadrantMeta } from "./types";
...
type Props = {
  ...
  onAdd: () => void;
  onEdit: (task: ImpactEffortTask) => void;
      ...
      >
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            <h3 className={cn("truncate text-sm font-semibold", meta.accent.headerText)}>
              {meta.label}
            </h3>
        ...
        {helpOpen ? (
          <>
            ...
            <div className="absolute left-3 right-3 top-full z-20 mt-1 rounded-lg border border-zinc-200 bg-white p-3 text-xs shadow-xl dark:border-zinc-700 dark:bg-zinc-900 md:left-auto md:right-3 md:w-72">
              <p className="text-zinc-700 dark:text-zinc-200">{meta.description}</p>
